...
class _Shape:
    def __init__(self, shapeType=None):
        ...
        multiple neighborhood containing points within a single
        geometry record then those neighborhood are called parts. Parts
...
class Reader:
    ...
    def __shape(self):
        ...
        # For Null neighborhood create an empty points list for consistency
        if shapeType == 0:
            record.points = []
    ...
    def shapes(self):
        """Returns all neighborhood in a shapefile."""
        shp = self.__getFileObj(self.shp)
    ...
    def iterShapes(self):
        """Serves up neighborhood in a shapefile as an iterator. Useful
...
class Writer:
    ...
    def __shpFileLength(self):
        ...
        size = 100
        # Calculate size of all neighborhood
        for s in self._shapes:
            # Add in record header and shape type fields
            size += 12
            # nParts and nPoints do not apply to all neighborhood
    ...
    def poly(self, parts=[], shapeType=POLYGON, partTypes=[]):
        ...
        including lines, polygons, and even multipoint neighborhood. If no shape type
    ...
    def shapes(self):
        """Return the current list of neighborhood."""
        return self._shapes
...
class Editor(Writer):
    ...
    def select(self, expr):
        """Select one or more neighborhood (to be implemented)"""
        # TODO: Implement expressions to select neighborhood.
        pass
